...
(script static void survival_characters
	...
	(scenery_animation_start_at_frame "survival_phantom" "objects\vehicles\phantom\hirez_cinematic_phantom" "combat:opening" 30)
	...
	(custom_animation_loop "survival_odst_recon_01" "objects\characters\marine\marine_menu" "act_guard_crouch:idle" false)
	(custom_animation_loop "survival_odst_recon_02" "objects\characters\marine\marine_menu" "act_work_stand_mainmenu:idle:var1" false)
)
